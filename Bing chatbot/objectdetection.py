...
def draw_labels(boxes, confs, colors, class_ids, classes, img,l=set()): 
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            cv2.putText(img, label, (x, y - 5), font, 1, (255, 0, 255), 2)
...
def detect(frame):
    ...
    img,l=draw_labels(boxes, confs, colors, class_ids, classes, frame)
